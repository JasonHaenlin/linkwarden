...
${getCustomPrompt(`You are a Bookmark Manager that should extract relevant tags from the following text, here are the rules:
...
${getCustomPrompt(`You are a Bookmark Manager that should match the following text with predefined tags.
...
${getCustomPrompt(`You are a Bookmark Manager that should match the following text with existing tags.
